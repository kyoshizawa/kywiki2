...
| v0.2       | 2026-02-09 | 文言の調整 (仕向け先⇒接続コードに変更) | k_yoshizawa |
---
...
| アプリ | 変更内容 |
|--------|---------|
| AP02 CAFIS業務処理サービス | 接続先をAP03→Routing Engine(7000)に変更 |
| AP22 CARDNET業務サービス | 接続先をFEXICS→Routing Engine(5000)に変更 |
