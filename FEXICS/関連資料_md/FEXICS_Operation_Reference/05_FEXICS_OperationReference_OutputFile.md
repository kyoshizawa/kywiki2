...
## 5.4 FEXICS情報出力ファイル（システム／エラー情報）

FEXICSは、起動や終了などのイベントや障害発生時の情報を **STDTXTファイル** に記録します。  
また、システムの運用に係わる下記障害事象を **ERRTXTファイル** に記録します。

- 電文異常の発生
- 取消電文の再送エラー
- FEXICSの障害（ジャーナルファイルへの書込みエラーなど）

ファイルに出力される内容は重大度によって分類され、設定ファイルで収集するレベルを指定できます。  
ファイルはテキスト形式で、`%FX_LOG%` ディレクトリに出力されます。

---

### ■ ファイル名一覧（例：CAFIS）

- FEXICS Daemon システム情報  
  `fxd_cf_yymmdd.stdtxt`

- FEXICS Daemon エラー情報  
  `fxd_cf_yymmdd.errtxt`

- FEXICS API システム情報  
  `fxapi_cf_yymmdd.stdtxt`

- FEXICS API エラー情報  
  `fxapi_cf_yymmdd.errtxt`
...
```
%FX_LOG%\fxd_cn_yymmdd.stdtxt
<< 04/03/26 16:38:05.859 L:4 p:3264 t:3268 cfparam.cpp(853) OpenConfig() return(0)
<< 04/03/26 16:38:05.859 L:4 p:3264 t:3268 csocket.cpp(180) bind to 127.0.0.1:0
<< 04/03/26 16:38:05.859 L:4 p:3264 t:3268 csocket.cpp(180) bind to 127.0.0.1:5001
<< 04/03/26 16:38:05.875 L:4 p:3264 t:3276 csocket.cpp(180) bind to 172.27.98.124:2100
<< 04/03/26 16:38:11.531 L:1 p:3264 t:3276 cntele.cpp(451) センター側ソケット接続 fd=1824
<< 04/03/26 16:38:11.531 L:3 p:3264 t:3276 cnsock.cpp(171) accept socket fd=1824 172.27.98.124:1178
<< 04/03/26 16:38:11.531 L:4 p:3264 t:3276 csocket.cpp(180) bind to 172.27.98.124:0
<< 04/03/26 16:38:11.546 L:4 p:3264 t:3276 cnsock.cpp(204) Accept Index=0/1
<< 04/03/26 16:38:11.546 L:1 p:3264 t:3276 cntele.cpp(451) センター側ソケット接続 fd=1800
<< 04/03/26 16:38:11.546 L:3 p:3264 t:3276 cnsock.cpp(171) accept socket fd=1800 172.27.98.124:1179
<< 04/03/26 16:38:11.546 L:4 p:3264 t:3276 csocket.cpp(180) bind to 172.27.98.124:0
<< 04/03/26 16:38:11.546 L:3 p:3264 t:3268 apisock.cpp(78) accept socket fd=1784 127.0.0.1:1181
<< 04/03/26 16:38:11.546 L:4 p:3264 t:3276 cnsock.cpp(204) Accept Index=1/2
<< 04/03/26 16:38:11.546 L:4 p:3264 t:3276 cntele.cpp(1621) fxcSendMsg() action=0
<< 04/03/26 16:38:11.562 L:4 p:3264 t:3276 cntele.cpp(1632) fxcSendMsg() Message 0000 was passed to API
<< 04/03/26 16:38:11.578 L:4 p:3264 t:3268 cnapitele.cpp(511) Receive data from queue. size=1092,type=0000
<< 04/03/26 16:38:11.578 L:4 p:3264 t:3268 apisock.cpp(47)
```


## 5.5 内部保存ファイル

下記3ファイルが FEXICS 内部保存ファイルとして記録されます。
...
#### ■ 精査集積ファイル
カット対象日付（または CAFIS 接続時は CAFIS 処理月日）ごとの精査集積情報を保存します。  
参照には専用ツールを使用します。（参照：3.6 fxview コマンド）
...
※ CAFIS の精査集積情報は、被仕向会社コード毎に保持されます。

---

#### ■ 内部情報記録ファイル
FEXICS の内部状態情報を保存します。
...
| 種別 | ファイル名 |
|------|-----------|
| 精査集積ファイル | sum_cn_yymmdd.dat |
| 内部情報記録ファイル | fxsave_cn.dat |
| 暗号化キーファイル | crypt_cn.dat |